...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Area Virtual del Taller</title>
        <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta name="description" content="Servisoft">
        <meta name="author" content="Hector Peralta" />
  ...
  <!--body class="skin-blue fixed" background="assets/img/fondo.jpg"-->
  <body class="skin-blue fixed">
    <div class="wrapper">
      
      <header class="main-header" style="background:#00C2A8">
        <!-- 1-Logo CREAR START-->
        <a href="?module=start" class="logo" style="background:#00C2A8">
          <img src="assets/img/frio_2.png" width="200" height="200" alt="Logo" > 
        </a> 
   
        <!-- 2- Sidebar Menu-->
        <nav class="navbar navbar-static-top" role="navigation" style="background:#00C2A8">
      ...
      <div class="content-wrapper" >
        ...
        <footer class="main-footer">
            <strong>
                Copyrigth &copy; <?php echo date('Y'); ?> - Desarrollado por 
                <a href="https://www.linkedin.com/in/hector-peralta-ab3a2a1b8/" target="_blank">Hector Peralta</a>.
            </strong>
        </footer>
