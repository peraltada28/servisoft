            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <form role="form" class="form-horizontal" action="modules/14_promociones/proces.php?act=insert" method="POST">
                            <div class="box-body">
                                <?php //METODO PARA GENERAR CODIGO
                                    $query_cod =mysqli_query($mysqli, "SELECT MAX(pro_cod) AS id FROM promociones")
                                                                    or die('Error '.mysqli_error($mysqli));
                                    
                                    $count = mysqli_num_rows($query_cod);
                                    if($count<>0){
                                        $data_cod = mysqli_fetch_assoc($query_cod);
                                        $pro_cod = $data_cod['id'] + 1;
                                    } else {
                                        $pro_cod = 1;
                                    }
                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="pro_cod" value="<?php echo $pro_cod; ?>" readonly>
                                    </div>
                                    <!---------------------->
                                    <label class="col-sm-1 control-label">Fecha</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control date-picker" data-date-format="dd-mm-yy" name="pro_fecha" autocomplete="of" 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="pro_descri" placeholder="Ingresa una descripcion" required>
                                    </div>
                                    <!---------------------> 
                                    <label class="col-sm-1 control-label">Porcentaje</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="pro_porcen" placeholder="Ingresa porcentaje"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="date" class="form-control" name="pro_fecha_in" autocomplete="off" value="" required>
                                    </div>
                                    <!---------------------->
                                    <label class="col-sm-2 control-label">Fecha hasta:</label>
                                    <div class="col-sm-2">
                                        <input type="date" class="form-control" name="pro_fecha_fin" autocomplete="off" value="" required>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <a href="?module=promociones" class="btn btn-default btn-reset">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
