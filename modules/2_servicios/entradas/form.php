<?php 
    if($_GET['form']=='add'){ ?>
      ...
      <h1>
        <i class="fa fa-edit icon-title">Agregar Entrada</i>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form role="form" class="form-horizontal" action="modules/entradas/proces.php?act=insert" method="POST">
                        <div class="box-body">
                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    autocomplete="off" required>
                                        <option value=""></option>
                                        <?php 
                                            $query_mot = mysqli_query($mysqli, "SELECT * FROM motivos where cod_motivo !=3
                            ...
                            <div class="box-footer">
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        ...
                                        <a href="?module=entradas" class="btn btn-default btn-reset">Cancelar</a>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function load(page){
            ...
            $("#loader").fadeIn('slow');
            $.ajax({
                url:'./ajax/vehiculos.php',//vehiculos_productos_pedidos
                data: parametros,
